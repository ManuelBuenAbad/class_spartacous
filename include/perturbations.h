...
struct perturbations
{
  ...
  //spartacous: presence of new fluid delta perturbations
  short has_source_delta_pacdm;  /**< do we need source for delta of partially acoustic dark matter? */
  short has_source_delta_pacdr;  /**< do we need source for delta of partially acoustic dark radiation? */
  //spartacous
  ...
  //spartacous: presence of new fluid theta perturbations
  short has_source_theta_pacdm;  /**< do we need source for theta of partially acoustic dark matter? */
  short has_source_theta_pacdr;  /**< do we need source for theta of partially acoustic dark radiation? */
  //spartacous
  ...
  //spartacous: indices of new fluid delta perturbations
  int index_tp_delta_pacdm; /**< index value for delta of partially acoustic dark matter */
  int index_tp_delta_pacdr; /**< index value for delta of partially acoustic dark radiation */
  //spartacous
  ...
  //spartacous: indices of new fluid theta perturbations
  int index_tp_theta_pacdm;   /**< index value for theta of partially acoustic dark matter */
  int index_tp_theta_pacdr;   /**< index value for theta of partially acoustic dark radiation */
  //spartacous
...
struct perturbations_vector
{
  ...
  //spartacous: indices of new fluid perturbations
  int index_pt_delta_pacdm; /**< pacdm density */
  int index_pt_theta_pacdm; /**< pacdm velocity */
  int index_pt_delta_pacdr; /**< pacdr density */
  int index_pt_theta_pacdr; /**< pacdr velocity */
  //spartacous
