...
cdef extern from "class.h":
    ...
    cdef struct background:
        ...
        #spartacous: new background indices
        int index_bg_rho_pacdm
        int index_bg_xa_pacdr
        int index_bg_rho_pacdr
        int index_bg_p_pacdr
        ...
        #spartacous: variables and parameters
        double Omega0_dm_tot
        double Omega0_pacdm
        double m_pacdm
        double Omega0_pacdr
        double N_UV
    ...
    cdef struct perturbations:
        ...
        #spartacous: presence of delta perturbations
        short has_source_delta_pacdm
        short has_source_delta_pacdr
        #spartacous
        ...
        #spartacous: presence of theta perturbations
        short has_source_theta_pacdm
        short has_source_theta_pacdr
        #spartacous
        ...
        #spartacous: indices of delta perturbations
        int index_tp_delta_pacdm
        int index_tp_delta_pacdr
        #spartacous
        ...
        #spartacous: indices of theta perturbations
        int index_tp_theta_pacdm
        int index_tp_theta_pacdr
        #spartacous
