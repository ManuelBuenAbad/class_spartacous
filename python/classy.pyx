...
cdef class Class:
   ...
   #################################
    ...
    def Omega0_dm_tot(self):
        ...
        """
        return self.ba.Omega0_dm_tot

    def Omega0_pacdm(self):
        """
        The abundance of the PAcDM.
        """
        return self.ba.Omega0_pacdm

    def m_pacdm(self):
        """
        The mass of the PAcDM (chi_2) [GeV].
        """
        return self.ba.m_pacdm

    def Omega0_pacdr(self):
        """
        The abundance of the PAcDR, today.
        """
        return self.ba.Omega0_pacdr

    def N_UV(self):
        """
        The extra number of neutrino families in the PAcDR, in the UV.
        """
        return self.ba.N_UV

    def N_IR(self):
        """
        The extra number of neutrino families in the PAcDR, in the IR.
        """
        return self.ba.N_IR

    def g_UV(self):
        """
        The d.o.f. in the PAcDR, in the UV (including factors of 7/8 for fermions).
        """
        return self.ba.g_UV

    def g_IR(self):
        """
        The d.o.f. in the PAcDR, in the IR (including factors of 7/8 for fermions).
        """
        return self.ba.g_IR

    def r_g(self):
        """
        The step from the decrease in the degrees of freedom in PAcDR in going from UV --> IR.
        """
        return self.ba.r_g

    def N_step(self):
        """
        The size of step in terms of extra neutrino families.
        """
        return self.ba.N_step

    def T_pacdr(self):
        """
        The PAcDR temperature [K] today.
        """
        return self.ba.T_pacdr

    def xi_pacdr(self):
        """
        The PAcDR temperature [K] today.
        """
        return self.ba.T_pacdr/self.ba.T_cmb

    def T_pacdr_wouldbe(self):
        """
        The would-be PAcDR temperature [K] today, had freeze-out not taken place.
        """
        return self.ba.T_pacdr_wouldbe

    def m_pacdr(self):
        """
        The mass of massive PAcDR component (psi) that freezes-out [GeV].
        """
        return self.ba.m_pacdr

    def a_tr(self):
        """
        The transition scale factor, defined to be T_pacdr/m_pacdr.
        """
        return self.ba.a_tr

    def xfo_pacdr(self):
        """
        The ratio m_pacdr/T_pacdr at the time of the massive PAcDR's freeze-out.
        """
        return self.ba.xfo_pacdr

    def alpha_pac(self):
        """
        The interaction strength  for PAcDM and PAcDR scattering (g^2/(4*pi)).
        """
        return self.ba.alpha_pac
    ...
    def Om_pacdm(self, z):
        ...
        Return the pacdm density fraction (exactly, the ratio of quantities defined by Class as
        index_bg_rho_pacdm and index_bg_rho_crit in the background module)
        ...
        if self.ba.has_pacdm == True:
            ...
            Om_pacdm = pvecback[self.ba.index_bg_rho_pacdm]/pvecback[self.ba.index_bg_rho_crit]
    ...
    def Om_pacdr(self, z):
        ...
        Return the pacdr density fraction (exactly, the ratio of quantities defined by Class as
        index_bg_rho_pacdr and index_bg_rho_crit in the background module)
        ...
        if self.ba.has_pacdr == True:
            ...
            Om_pacdr = pvecback[self.ba.index_bg_rho_pacdr]/pvecback[self.ba.index_bg_rho_crit]
    ...
    def x_pacdr(self, z):
        ...
        Return the ratio m_pacdr/T_pacdr(z).
        ...
        if self.ba.has_pacdr == True:
            ...
            x = pvecback[self.ba.index_bg_xa_pacdr]
    ...
    def N_pacdr(self, z):
        ...
        Return the effective number of neutrino families in the PAcDR N(z).
        ...
        if self.ba.has_pacdr == True:
            ...
            n = pvecback[self.ba.index_bg_N_pacdr]
    ...
    def w_pacdr(self, z):
        ...
        Return the equation of state of the PAcDR w(z) = p(z)/rho(z).
        ...
        if self.ba.has_pacdr == True:
            ...
            w = pvecback[self.ba.index_bg_w_pacdr]
    ...
    def dw_pacdr(self, z):
        ...
        Return the conformal time derivative of the equation of state of the PAcDR, dw(z)/dtau.
        ...
        if self.ba.has_pacdr == True:
            ...
            dw = pvecback[self.ba.index_bg_dw_pacdr]
            dw *= (pvecback[self.ba.index_bg_H] * a**2.)
    ...
    def cs2_pacdr(self, z):
        """
        cs2(z)

        Return the sound speed of the PAcDR, cs2(z).
        ...
        if self.ba.has_pacdr == True:
            ...
            cs2 = pvecback[self.ba.index_bg_cs2_pacdr]
    ...
    def nsub_at_z(self, z):
        """
        n_sub(z)

        Return the number density of the annihilating particles, n_sub(z) [eV^3].
        ...
        if self.ba.has_pacdr == True:
            ...
            n_sub = pvecback[self.ba.index_bg_nsub_pacdr]
    ...
    def Gamma_pacdr_at_z(self, z):
        """
        Gamma(z)

        Return the momentum-transfer rate from the PAcDR to the PAcDM, Gamma(z) [Mpc^-1].
        ...
        if self.ba.has_pacdr == True:
            ...
            Gamma = pvecback[self.ba.index_bg_Gamma_pacdr]
    ...
    def z_dec(self, z_arr=np.logspace(-3, 7, 10001)):
        """

        Return the redshift at which Gamma(z_dec) = H(z_dec).
        """

        H_arr = np.array([self.Hubble(z) for z in z_arr])
        Gamma_arr = np.array([self.Gamma_pacdr_at_z(z) for z in z_arr])

        GH_cross = np.abs(Gamma_arr/H_arr - 1)
        idx_cross = np.argmin(GH_cross)
...
#                raise CosmoSevereError(self.fo.error_message)
    ...
    def get_sources(self):
        ...
        #spartacous
        if self.pt.has_source_delta_pacdm:
            indices.append(self.pt.index_tp_delta_pacdm)
            names.append("delta_pacdm")
        if self.pt.has_source_delta_pacdr:
            indices.append(self.pt.index_tp_delta_pacdr)
            names.append("delta_pacdr")
        #spartacous
        ...
        #spartacous
        if self.pt.has_source_theta_pacdm:
            indices.append(self.pt.index_tp_theta_pacdm)
            names.append("theta_pacdm")
        if self.pt.has_source_theta_pacdr:
            indices.append(self.pt.index_tp_theta_pacdr)
            names.append("theta_pacdr")
        #spartacous
